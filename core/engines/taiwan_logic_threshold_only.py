...
class TaiwanLogicThresholdOnlyEngine(BasePatternEngine):
    """
    Taiwan Market Engine - Logic Threshold Only
    ...
    def __init__(self):
        ...
        self.min_floor = 0.009  # 0.9% minimum move for Taiwan market (fractional)
        
    def analyze(self, df, settings):
        """
        Analyze Taiwan stocks with threshold-only logic.
        ...
        # Direction: Trend Following (ride the move)
        ...
        # Rule 3: Best Fit Selection (Count >= 15 for Taiwan)
        ...
        return [{
            'engine': 'TAIWAN_LOGIC_THRESHOLD_ONLY',
