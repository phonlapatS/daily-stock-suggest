...
class USLogicThresholdOnlyEngine(BasePatternEngine):
    """
    US Market Engine - Logic Threshold Only
    ...
    def __init__(self):
        ...
        self.min_floor = 0.006  # 0.6% minimum move for US market (fractional)
        
    def analyze(self, df, settings):
        """
        Analyze US stocks with threshold-only logic.
        ...
        # Rule 3: Best Fit Selection (Count >= 15 for US)
