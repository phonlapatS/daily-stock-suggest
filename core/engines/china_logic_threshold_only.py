...
class ChinaLogicThresholdOnlyEngine(BasePatternEngine):
    """
    China Market Engine - Logic Threshold Only
    ...
    def __init__(self):
        super().__init__()
        # China market specific settings
        self.min_floor = 0.008  # 0.8% minimum move for China market (fractional)
        
    def analyze(self, df, settings):
        """
        Analyze China stocks with threshold-only logic.
        ...
        # Rule 3: Best Fit Selection (Count >= 15 for China)
        ...
        return [{
            'engine': 'CHINA_LOGIC_THRESHOLD_ONLY',
