#!/usr/bin/env python
"""
Test China Realistic Prob% - Quick Test (เฉพาะค่าที่สำคัญ)
"""
...
def main():
    """Main function"""
    print("="*100)
    print("Test China Realistic Prob% - Quick Test (เฉพาะค่าที่สำคัญ)")
    print("="*100)
    print()
    print("Goal: ลด Prob% ให้ realistic มากขึ้น (60-65%)")
    print("      โดยยังคง RRR >= 1.40, Stocks >= 4, Count >= 20")
    print()
    print("Strategy: ทดสอบเฉพาะค่าที่น่าจะได้ผลดีที่สุด")
    print("  1. เพิ่ม threshold_multiplier (ทำให้ pattern detection เข้มงวดขึ้น)")
    print("  2. เพิ่ม min_stats (ต้องการ pattern ที่มีสถิติมากกว่า)")
    print("  3. รวมกัน")
    print()
    ...
    test_configs = [
        ...
        # Option 3: Combined - threshold_multiplier + min_stats (most promising)
        ...
        # Option 4: All combined (most aggressive)
    ...
    # Save results
    output_file = 'data/china_realistic_prob_quick_test_results.csv'
