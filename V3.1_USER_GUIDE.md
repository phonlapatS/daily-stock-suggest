...
- **Chance**: The predicted direction (🟢 UP or 🔴 DOWN) - always shows the more likely outcome.
- **Prob**: Probability of the predicted direction. **Always ≥50%** because it compares UP vs DOWN days only (FLAT days excluded).
...
- **Prob**: Probability of the streak outcome.
  - `🟢 CONT.`: Likely to continue (≥50%).
  - `🔴 REV.`: Likely to reverse/end (<50%).
